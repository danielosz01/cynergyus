            ...
            <div class="services">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="card">
                                <img src="src/assets/images/page-quality-svgrepo-com.svg" class="card-img-top" alt="..."/>
                                <div class="card-body">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <img src="src/assets/images/content-management-svgrepo-com (1).svg" class="card-img-top" alt="..."/>
                                <div class="card-body">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <img src="src/assets/images/Charts 2.svg" class="card-img-top" alt="..."/>
                                <div class="card-body">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <img src="src/assets/images/color.svg" class="card-img-top" alt="..."/>
                                <div class="card-body">
